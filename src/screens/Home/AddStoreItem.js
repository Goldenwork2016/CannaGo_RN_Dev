    ...
    return (
      <View style={styles.container}>
        <ScrollView style={{width:'100%'}}>
          <View style={styles.container}>
            <Text style={{...styles.CartTitle, marginTop:Platform.OS=='ios'?7:-10}}>Add Item in Your Store</Text>
            ...
            <View style={{...styles.inputArea, marginTop:0}}>
              ...
              <TouchableOpacity style={{...styles.signinBtn, width:170, alignSelf:'center'}} onPress={()=>{this.props.navigation.navigate("App")}}>
